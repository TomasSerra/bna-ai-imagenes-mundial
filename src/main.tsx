...
// text/image selection and drag. The /image route is shown on the user's
// phone after scanning a QR, and must keep native long-press → "Save image",
...
const isMobilePreviewRoute = () => window.location.pathname.startsWith('/image');
